import requests, base64, uuid, os, json, sys
...
def _delaytime(value):
    for remaining_time in range(value, -1, -1):
        colors = [
            "\033[1;37mA\033[1;36mN\033[1;35mH\033[1;32mC\033[1;31mO\033[1;34mD\033[1;33mE\033[1;36m🍋 - Tool\033[1;36m Vip \033[1;31m\033[1;32m",
            "\033[1;34mA\033[1;31mN\033[1;37mH\033[1;36mC\033[1;32mO\033[1;35mD\033[1;37mE\033[1;33m🍋 - Tool\033[1;34m Vip \033[1;31m\033[1;32m",
            "\033[1;31mA\033[1;37mN\033[1;36mH\033[1;33mC\033[1;35mO\033[1;32mD\033[1;34mE\033[1;35m🍋 - Tool\033[1;37m Vip \033[1;33m\033[1;32m",
            "\033[1;32mA\033[1;33mN\033[1;34mH\033[1;35mC\033[1;36mO\033[1;37mD\033[1;36mE\033[1;31m🍋 - Tool\033[1;31m Vip \033[1;31m\033[1;32m",
            "\033[1;37mA\033[1;34mN\033[1;35mH\033[1;36mC\033[1;32mO\033[1;33mD\033[1;31mE\033[1;37m🍋 - Tool\033[1;34m Vip \033[1;31m\033[1;32m",
            "\033[1;34mA\033[1;33mN\033[1;37mH\033[1;35mC\033[1;31mO\033[1;36mD\033[1;36mE\033[1;32m🍋 - Tool\033[1;36m Vip \033[1;31m\033[1;32m",
            "\033[1;36mA\033[1;35mN\033[1;31mH\033[1;34mC\033[1;37mO\033[1;35mD\033[1;32mE\033[1;36m🍋 - Tool\033[1;33m Vip \033[1;31m\033[1;32m",
        ]
        for color in colors:
...
def chongblock(delaybl):
    for i in range(delaybl, -1, -1):
        Write.Print(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mĐang chống FB quét Spam vui lòng chờ {i} giây  \r",
...
def _Infofb(cookie):
    ...
    try:
        get = get.url
        get = requests.get(
            get, headers=heads, cookies={"cookie": cookie}, proxies=proxies
        ).text
...
def _React_Cmt(cookie, idfb, fb1, uid, type):
    ...
    _data = {
        ...
        "fb_api_caller_class": "RelayModern",
        "fb_api_req_friendly_name": "CometUFIFeedbackReactMutation",
        "variables": '{"input":{"attribution_id_v2":"CometVideoHomeNewPermalinkRoot.react,comet.watch.injection,via_cold_start,1719930662698,975645,2392950137,,","feedback_id":"'
        + _encode_to_base64("feedback:" + str(uid))
        + '","feedback_reaction_id":"'
        + _id_reac
        + '","feedback_source":"TAHOE","is_tracking_encrypted":true,"tracking":[],"session_id":"'
        + str(uuid.uuid4())
        + '","downstream_share_session_id":"'
        + str(uuid.uuid4())
        + '","downstream_share_session_origin_uri":"https://fb.watch/t3OatrTuqv/?mibextid=Nif5oz","downstream_share_session_start_time":"'
        + _d
        + '","actor_id":"'
        + idfb
...
def _Page(cookie, idfb, fb1, id):
    ...
    _data = {
        ...
        "variables": '{"input":{"is_tracking_encrypted":false,"page_id":"'
        + str(uid)
        + '","source":null,"tracking":null,"actor_id":"'
        + str(idfb)
        + '","client_mutation_id":"1"},"scale":1}',
        "server_timestamps": "true",
...
def Nhap_Cookie():
    ...
    while True:
        demck += 1
        ck = input(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập Cookie Facebook Thứ: {vang}{demck}{trang}: "
        )
        if ck == "" and demck > 1:
            break
        _info = _Infofb(ck)
        if _info == False:
            print(
                "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mCookie Facebook Die ! Vui Lòng Nhập Lại !!!"
            )
            demck -= 1
        else:
            print("\033[97m════════════════════════════════════════════════")
            print(
                f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mID FACEBOOK: {vang}{_info[1]} {red}| {luc}TÊN FACEBOOK: {vang}{_info[2]}"
            )
            print("\033[97m════════════════════════════════════════════════")
            listck.append(ck)
    return listck
...
def convert_proxy_format(proxy_str):
    # Match dạng: http://ip:port:user:pass
    match = re.match(
        r"(http[s]?://)?(?P<ip>[^:]+):(?P<port>\d+):(?P<user>[^:]+):(?P<pass>.+)",
        proxy_str,
    )
    if match:
        ip = match.group("ip")
        ...
        # Trường hợp proxy đã đúng định dạng hoặc không cần auth
        return {
            "http": proxy_str,
            "https": proxy_str,
        }
...
def check_proxy(proxy):
    try:
        global proxies
        proxies = convert_proxy_format(proxy)
        response = requests.get("https://httpbin.org/ip", proxies=proxies, timeout=10)
        response.raise_for_status()
        ip_info = response.json()
        print(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32m[✅] Proxy hoạt động. IP của bạn là: {ip_info['origin']}"
        )
        return True
    except Exception as e:
        print(e)
        print(f"[❌] Proxy lỗi vui lòng nhập lại")
        return False
...
def Main():
    ...
    while True:
        if os.path.exists("proxy.txt"):
            ...
            with open("proxy.txt", "r") as pf:
                proxy_input = pf.read().strip()
            if proxy_input:
                if check_proxy(proxy_input):
                    with open("proxy.txt", "w") as pf:
                        pf.write(proxy_input)
                    break
                else:
                    os.remove("proxy.txt")
                    continue
        else:
            chon_proxy = Write.Input(
                "[❣] ✈ Bạn có muốn dùng proxy không? (1 = Có, 2 = Không): ",
                Colors.purple_to_blue,
                interval=0.0001,
            )
            if chon_proxy == "1":
                proxy_input = input(
                    "[❣] ✈ Nhập proxy của bạn (VD: http://ip:port:user:pass): "
                ).strip()
                if check_proxy(proxy_input):
                ...
                print(
                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mKhông sử dụng proxy"
                )
                break
    while True:
        if os.path.exists("configttc.txt"):
            ...
            if login.json()["status"] == "success":
                ...
                print(
                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập {vang}[{trang}1{vang}] {luc}Giữ Lại Tài Khoản {lam}{user}"
                )
                print(
                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập {vang}[{trang}2{vang}] {luc}Nhập Access_Token TTC Mới"
                )
                chon = Write.Input(
                ...
                if chon == "2":
                    ...
                    print(
                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mLựa chọn không xác định !!!"
                    )
                    continue
            else:
                os.remove("configttc.txt")
        if not os.path.exists("configttc.txt"):
            tk = input(
                f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập Access_token TTC{trang}: "
            )
        ...
        if login.json()["status"] == "success":
            ...
            print("\033[97m════════════════════════════════════════════════")
            print(
                f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTên Tài Khoản: {trang}{user} | {luc}Xu Hiện Tại: {trang}{sodu}"
            )
            print("\033[97m════════════════════════════════════════════════")
            break
        else:
    ...
    while True:
        if os.path.exists("Cookie_FB.txt"):
            print(
                f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập {vang}[{trang}1{vang}] {luc}Sử Dụng Cookie Facebook Đã Lưu "
            )
            print(
                f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập {vang}[{trang}2{vang}] {luc}Nhập Cookie Facebook Mới"
            )
            chon = Write.Input(
                f"[❣] ✈ Nhập Lựa Chọn Của Bạn: ", Colors.purple_to_blue, interval=0.0001
            )
            if chon == "1":
                print(
                    "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mĐang Lấy Dữ Liệu Đã Lưu"
                )
                sleep(1)
    ...
    print("\033[97m════════════════════════════════════════════════")
    print(
        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTên Tài Khoản: {trang}{user} | {luc}Xu Hiện Tại: {trang}{sodu} | {luc}Số Nick Facebook: {trang}{len(listck)}"
    )
    print("\033[97m════════════════════════════════════════════════")
    for i, task in enumerate(
        ...
        print(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập {vang}[{trang}{i}{vang}]{luc} - {task.ljust(12)}"
        )
    print(
        "\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈  Có Thể Chọn Nhiều Nhiệm Vụ (VD: 123...)"
    )
    print("\033[97m════════════════════════════════════════════════")
    nhiemvu = input(
        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập Nhiệm Vụ Cần Chạy{trang}: "
    )
    min = int(
        input(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập Delay Min{trang}: "
        )
    )
    max = int(
        input(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập Delay Max{trang}: "
        )
    )
    nvblock = int(
        input(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mSau Bao Nhiêu Nhiệm Vụ Thì Chống Block{trang}: "
        )
    )
    delaybl = int(
        input(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mSau {trang}{nvblock} \033[1;32mNhiệm Vụ Thì Nhiệm Vụ Nghỉ Ngơi{trang}: "
        )
    )
    doinick = int(
        input(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mSau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick{trang}: "
        )
    )
    nhiemvuloi = int(
        input(
            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mLỗi Bao Nhiêu Nhiệm Vụ Thì Xóa Cookie{trang}: "
        )
    )
    while True:
        if len(listck) == 0:
            print(
                f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mĐã Xoá Tất Cả Cookie, Vui Lòng Nhập Lại"
            )
            listck = Nhap_Cookie()
            with open("Cookie_FB.txt", "w") as f:
                json.dump(listck, f)
        for ck in listck:
            loilike, loicamxuc, loicxcmt, loifl, loicmt, loishare, loilikepage = (
                0,
                0,
                0,
                0,
            ...
            if _info != False:
                ...
                print(
                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mCookie Tài Khoản {uidfb} Die",
                    end="\r",
                )
                sleep(3)
                print("                                     ", end="\r")
            ...
            if "1" in cauhinh:
                ...
                print(
                    luc
                    + f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mĐang Chạy ID FB: {vang}{uidfb} {red}| {luc}Tên FB: {vang}{tenfb}"
                )
                print("\033[97m════════════════════════════════════════════════")
            else:
                print("\033[97m════════════════════════════════════════════════")
                print(
                    luc
                    + f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mCấu Hình Thất Bại UID FB: {vang}{uidfb} {red}| {luc}Tên FB: {vang}{tenfb}"
                )
                print("\033[97m════════════════════════════════════════════════")
                continue
            ptool = 0
            print(
                f"\033[1;36m|STT\033[1;97m| \033[1;33mThời gian ┊ \033[1;32mStatus | \033[1;31mType Job | \033[1;32mID Acc | \033[1;32mXu |"
            )
            while True:
                ...
                if nvlikevip == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Like Vip                            ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mLấy nhiệm vụ sau 17 giây                            ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Like Vip                      ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if "success" in getuid:
                                ...
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mlink bài viết die",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                            ...
                            if like == False:
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mFAIL {lam}LIKE{trang}: {vang}{uid}             ",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                                ...
                                if "mess" in nhan:
                                    ...
                                    chuoi = (
                                        ...
                                        f"\033[1;33m{time}\033[1;31m\033[1;97m  | "
                                        f"\033[1;32mSuccess\033[1;31m\033[1;97m | "
                                        f"\033[1;31mLIKEVIP\033[1;31m\033[1;32m\033[1;32m\033[1;97m |"
                                        f"\033[1;32m Ẩn ID\033[1;97m | \033[1;32m+1100xu \033[1;97m| "
                                    )
                                    print(chuoi)
                                    loilike = 0
                                    if dem % doinick == 0:
                                    ...
                                    if dem % nvblock == 0:
                                        ...
                                        _delaytime(randint(min, max))

                            if loilike >= nhiemvuloi:
                                _info = _Infofb(ck)
                                if _info != False:
                                    print(
                                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mCookie Tài Khoản {vang}{tenfb}{red} Đã Bị Out !!!                "
                                    )
                                else:
                                    print(
                                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mTài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Like {red}!!!					"
                                    )
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvlikethuong == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Like Thường                            ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Like Xu Thường                      ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if like == False:
                                ...
                                data = {"id": idpost}
                                nhan = requests.post(
                                    "https://tuongtaccheo.com/kiemtien/likepostcheo/nhantien.php",
                                    headers=headers,
                                    data=data,
                                    proxies=proxies,
                                ).json()
                                if "mess" in nhan:
                                    ...
                                    chuoi = (
                                        ...
                                        f"\033[1;33m{time}\033[1;31m\033[1;97m  | "
                                        f"\033[1;32mSuccess\033[1;31m\033[1;97m | "
                                        f"\033[1;31mLIKETHUONG\033[1;31m\033[1;32m\033[1;32m\033[1;97m |"
                                        f"\033[1;32m Ẩn ID\033[1;97m | \033[1;32m+300xu \033[1;97m| "
                                    )
                ...
                if nvreacvip == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mHết Nhiệm Vụ Cảm Xúc Vip                            ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Cảm Xúc Vip                       ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if "success" in getuid:
                                ...
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mlink bài viết die",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                            ...
                            if like == False:
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mFAIL {lam}{typee}{trang}: {vang}{uid}             ",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                                ...
                                if "mess" in nhan:
                                    ...
                                    chuoi = (
                                        ...
                                        f"\033[1;33m{time}\033[1;31m\033[1;97m  | "
                                        f"\033[1;32mSuccess\033[1;31m\033[1;97m | "
                                        f"\033[1;31mVIP\033[1;31m\033[1;32m\033[1;32m\033[1;97m |"
                                        f"\033[1;32m Ẩn ID\033[1;97m | \033[1;32m+1200xu \033[1;97m| "
                                    )
                            ...
                            if loicamxuc >= nhiemvuloi:
                                ...
                                if _info != False:
                                    ...
                                    print(
                                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mTài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Cảm Xúc {red}!!!					"
                                    )
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvreac == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Cảm Xúc                           ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Cảm Xúc                      ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if like == False:
                                ...
                                data = {"id": idpost}
                                nhan = requests.post(
                                    "https://tuongtaccheo.com/kiemtien/camxuccheo/nhantien.php",
                                    headers=headers,
                                    data=data,
                                    proxies=proxies,
                                ).json()
                                if "mess" in nhan:
                                    ...
                                    chuoi = (
                                        ...
                                        f"\033[1;33m{time}\033[1;31m\033[1;97m  | "
                                        f"\033[1;32mSuccess\033[1;31m\033[1;97m | "
                                        f"\033[1;31m{typee}\033[1;31m\033[1;32m\033[1;32m\033[1;97m |"
                                        f"\033[1;32m Ẩn ID\033[1;97m | \033[1;32m+700xu \033[1;97m| "
                                    )
                ...
                if nvreaccmt == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Cảm Xúc Cmt             ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Cảm Xúc Cmt                     ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if like == False:
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mFAIL {lam}{typee} CMT{trang}: {vang}{uid}             ",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                ...
                if nvfollow == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Follow              ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Follow                      ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if like == False:
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mFAIL {lam}FOLLOW{trang}: {vang}{uid}             ",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                                ...
                                data = {"id": idpost}
                                nhan = requests.post(
                                    "https://tuongtaccheo.com/kiemtien/subcheo/nhantien.php",
                                    headers=headers,
                                    data=data,
                                    proxies=proxies,
                                ).json()
                            ...
                            if loifl >= nhiemvuloi:
                                ...
                                if _info != False:
                                    ...
                                    print(
                                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mTài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Follow {red}!!!					"
                                    )
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvcmt == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Cmt              ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Cmt                      ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if like == False:
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mFAIL {lam}CMT{trang}: {vang}{uid}             ",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                                ...
                                data = {"id": idpost}
                                nhan = requests.post(
                                    "https://tuongtaccheo.com/kiemtien/cmtcheo/nhantien.php",
                                    headers=headers,
                                    data=data,
                                    proxies=proxies,
                                ).json()
                                if "mess" in nhan:
                                    ...
                                    chuoi = (
                                        ...
                                        f"\033[1;33m{time}\033[1;31m\033[1;97m  | "
                                        f"\033[1;32mSuccess\033[1;31m\033[1;97m | "
                                        f"\033[1;31mCMTCHEO\033[1;31m\033[1;32m\033[1;32m\033[1;97m | "
                                        f"\033[1;32m Ẩn ID\033[1;97m | \033[1;32m+1400xu \033[1;97m| "
                                    )
                            ...
                            if loicmt >= nhiemvuloi:
                                ...
                                if _info != False:
                                    ...
                                    print(
                                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mTài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Cmt {red}!!!					"
                                    )
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvshare == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Share              ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Share                      ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if share == False:
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mFAIL {lam}SHARE{trang}: {vang}{uid}             ",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                                ...
                                data = {"id": idpost}
                                nhan = requests.post(
                                    "https://tuongtaccheo.com/kiemtien/sharecheo/nhantien.php",
                                    headers=headers,
                                    data=data,
                                    proxies=proxies,
                                ).json()
                                if "mess" in nhan:
                                    ...
                                    chuoi = (
                                        ...
                                        f"\033[1;33m{time}\033[1;31m\033[1;97m  | "
                                        f"\033[1;32mSuccess\033[1;31m\033[1;97m | "
                                        f"\033[1;31mSHARE\033[1;31m\033[1;32m\033[1;32m\033[1;97m |"
                                        f"\033[1;32m Ẩn ID\033[1;97m | \033[1;32m+600xu \033[1;97m| "
                                    )
                            ...
                            if loishare >= nhiemvuloi:
                                ...
                                if _info != False:
                                    ...
                                    print(
                                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mTài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Share {red}!!!					"
                                    )
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if nvlikepage == 1:
                    ...
                    if like1 == []:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mHết Nhiệm Vụ Like Page             ",
                            end="\r",
                        )
                        sleep(2)
                        print(
                        ...
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mTìm Thấy {vang}{len(like2)} {luc}Nhiệm Vụ Like Page                     ",
                            end="\r",
                        )
                        for x in like2:
                            try:
                            ...
                            if likepage == False:
                                print(
                                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mFAIL {lam}LIKEPAGE{trang}: {vang}{uid}             ",
                                    end="\r",
                                )
                                sleep(2)
                                print(
                                ...
                                if "mess" in nhan:
                                    ...
                                    chuoi = (
                                        ...
                                        f"\033[1;33m{time}\033[1;31m\033[1;97m  | "
                                        f"\033[1;32mSuccess\033[1;31m\033[1;97m | "
                                        f"\033[1;31mLIKEPAGE\033[1;31m\033[1;32m\033[1;32m\033[1;97m |"
                                        f"\033[1;32m Ẩn ID\033[1;97m | \033[1;32m+1300xu \033[1;97m| "
                                    )
                            ...
                            if loilikepage >= nhiemvuloi:
                                ...
                                if _info != False:
                                    ...
                                    print(
                                        f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;91mTài Khoản {vang}{tenfb} {red}Đã Bị Block {vang}Like Page{red}!!!					"
                                    )
                                listck.remove(ck)
                                ptool = 1
                                break
                ...
                if (
                    ...
                    for i in range(10, 0, -1):
                        Write.Print(
                            f" Tất Cả Các Nhiệm Vụ Đã Hết, Vui Lòng Chờ {i} Giây ",
                            Colors.blue_to_cyan,
                            interval=0.0001,
                            end="\r",
                        )
...
def CheckKey():
    ...
    while True:
            ...
            try:
                with open("key.txt", "r") as f:
                    ...
                    response = requests.get(
                        "https://logtk.pro/api/key/getKey/" + key,
                        headers=headers,
                    )
                    response.raise_for_status()
                    ...
                    if get:
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mKey hợp lệ, đang đăng nhập tool..."
                        )
                        statusKey = get
                        sleep(2)
                        break
                        ...
                        os.remove("key.txt")
                        print(
                            f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mKey không hợp lệ vui lòng nhập lại"
                        )
                        sleep(2)
        ...
        if not os.path.exists("key.txt"):
            banner()
            print(
                f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mNhập key đã có"
            )
            key = Write.Input(
                f"[❣] ✈ Nhập Key đã có Của Bạn: ",
                Colors.purple_to_blue,
                interval=0.0001,
            )
            headers = {
            ...
            response = requests.patch(
                "https://logtk.pro/api/key/activeKey/" + key, headers=headers
            )
            ...
            if "error" in patch:
                print(
                    f"\033[1;97m[\033[1;91m❣\033[1;97m] \033[1;36m✈ \033[1;32mKey không hợp lệ, Vui lòng liên hệ admin"
                )
                sleep(2)
                continue
